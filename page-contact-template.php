...
<section class="u-center-text page-g contact-page Xu-subsection-spacer-top u-section-spacer-page" Xstyle="height: 100vh;">
    <!-- Logo -->
    <div class="logo-footer">
        <img src="<?php echo get_template_directory_uri(); ?>/img/appmea_white.png" id="logo" alt="logo-img" />
    </div>
    <!-- .Logo -->
